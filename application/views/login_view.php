...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: white;">Sistem Informasi <br/><b>Perpustakaan Masjid Sarbini</b></a>
  </div>
  ...
  <div class="login-box-body" style="border:2px solid #226bbf;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-warning btn-block btn-flat">Masuk</button>
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center bg-orange">
       <a style="color: white;"> Projek &copy; Sistem Perpustakaan Masjid Sarbini - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
